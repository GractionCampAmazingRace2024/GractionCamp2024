...
const errorMessages = [
  'Womp Womp...', 'L Bozo', 'Tough', 'Skill Issue', 'That was not very slay', 'ermmmm.... wrong',
  'Hint: Try Harder', 'Amazing....', 'Maybe I need to verify if you are a robot or not', 'Womp Womp...',
  'What the sigma', 'Chat... is this real?', 'What the skibidi toilet', 'One job...', 'Embarassinggg....',
  'Are you even trying?', 'Missed your shot...No Rizz', 'You got this one day!', 'Atleast you know what not to do',
  'You miss all the shots you dont take... I guess...', 'This is a whole mood… for the wrong reasons', 'Yikes! Not even close',
  'L + Ratio', 'Not the vibes', 'Sus password', "It's giving... Fail", 'Oopsies...', 'Hard Pass', 'No bueno...',
  'You hate to see it...', '...', "That's a no from me"
];
